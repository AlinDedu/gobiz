	...
	return (
		<>
			<Tr>
				...
				<Td>
					<Flex direction='column' gap='2'>
						<Input placeholder='Stripe ID' size='sm' value={stripeId} onChange={(e) => setStripeId(e.target.value)} />
						<Input placeholder='Subtitle' size='sm' value={subtitle} onChange={(e) => setSubtitle(e.target.value)} />
					</Flex>
				</Td>
				<Td>
					<Flex direction='column' gap='2'>
						<Input placeholder='Category' size='sm' value={category} onChange={(e) => setCategory(e.target.value)} />
						<Input placeholder='Price' size='sm' value={price} onChange={(e) => setPrice(e.target.value)} />
					</Flex>
				</Td>
				<Td>
					<Flex direction='column' gap='2'>
						<Input placeholder='Stock' size='sm' value={stock} onChange={(e) => setStock(e.target.value)} />
